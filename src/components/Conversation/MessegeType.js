            ...
            >
                <Stack spacing={2}>
                    <Stack
                        ...
                        <Image size={48} />
                        <Typography variant='caption'>Abstrict.png</Typography>
                        <IconButton>
                            <DownloadSimple />
                        </IconButton>
                    </Stack>
                    ...
                    <Stack
                        ...
                        <Stack spacing={2}>
                            ...
                            <Typography
                                ...
                                rel="noopener noreferrer" // security purpose (Prevents window.opener and browser from sending the Referer)
                                underline="hover"
                                target="_blank"
